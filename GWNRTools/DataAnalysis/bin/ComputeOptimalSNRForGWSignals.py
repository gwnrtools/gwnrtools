...
parser.add_argument('--dist', default=1.e3, type=float, help="distance to source in MegaParsecs")
parser.add_argument('--incl', default=0., type=float, help="inclination angle between orbital-L and line of sight")
