...
parser.add_option(
    "--mass1", help="Mass of the heavier object [Msun]", dest="mass1", type=float
)
parser.add_option(
    "--mass2", help="Mass of the lighter object [Msun]", dest="mass2", type=float
)
...
parser.add_option(
    "--ecc-min", help="Lower limit for eccentricity", type=float, default=0
)
parser.add_option(
    "--ecc-max", help="Upper limit for eccentricity", type=float, default=0
)
parser.add_option(
    "--anomaly-min", help="Lower limit for mean anomaly", type=float, default=0
)
parser.add_option(
    "--anomaly-max", help="Upper limit for mean anomaly", type=float, default=0
)
parser.add_option(
    "--spin1x", help="s1-x of the heavier object", dest="spin1x", type=float
)
parser.add_option(
    "--spin1y", help="s1-y of the heavier object", dest="spin1y", type=float
)
parser.add_option(
    "--spin1z", help="s1-z of the heavier object", dest="spin1z", type=float
)
parser.add_option(
    "--spin1z-min", help="Max s1-z of the heavier object", type=float, default=-0.99
)
parser.add_option(
    "--spin1z-max", help="Min s1-z of the heavier object", type=float, default=0.99
)
parser.add_option(
    "--spin1mag", help="s1-magnitude of the heavier object", dest="spin1mag", type=float
)
parser.add_option(
    "--spin2x", help="s2-x of the lighter object", dest="spin2x", type=float
)
parser.add_option(
    "--spin2y", help="s2-y of the lighter object", dest="spin2y", type=float
)
parser.add_option(
    "--spin2z", help="s2-z of the lighter object", dest="spin2z", type=float
)
parser.add_option(
    "--spin2z-min", help="Min s2-z of the lighter object", type=float, default=-1.0
)
parser.add_option(
    "--spin2z-max", help="Max s2-z of the lighter object", type=float, default=1.0
)
parser.add_option(
    "--spin2mag", help="s2-magnitude of the lighter object", dest="spin2mag", type=float
)
parser.add_option(
    "--lambda1-min", help="Lower limit for Lambda of M1", type=float, default=0
)
parser.add_option(
    "--lambda1-max", help="Lower limit for Lambda of M1", type=float, default=0
)
parser.add_option(
    "--lambda2-min", help="Lower limit for Lambda of M1", type=float, default=0
)
parser.add_option(
    "--lambda2-max", help="Lower limit for Lambda of M1", type=float, default=4500
)
...
if options.mchirp_min:
    ...
    mchirp_min = (2.0 * mass_min) * (
        (mass_max / mass_min) / (1.0 + (mass_max / mass_min)) ** 2
    ) ** 0.6
#
...
if options.eta_min:
    ...
    eta_min = (mass_max / mass_min) / (1.0 + (mass_max / mass_min)) ** 2
#
q_min = 10.0 / eta_mass1_to_mass2(eta_max, 10.0)
q_max = 10.0 / eta_mass1_to_mass2(eta_min, 10.0)
...
for i in np.arange(npoints):
    ...
    if (smplpt.spin1x or smplpt.spin1y or smplpt.spin1z) and not (
        ...
        s1mag = np.sqrt(
            smplpt.spin1x**2.0 + smplpt.spin1y**2.0 + smplpt.spin1z**2.0
        )
    ...
    if (smplpt.spin2x or smplpt.spin2y or smplpt.spin2z) and not (
        ...
        s2mag = np.sqrt(
            smplpt.spin2x**2.0 + smplpt.spin2y**2.0 + smplpt.spin2z**2.0
        )
        if options.spin2mag:
