...
parser.add_argument("--s1z", default=0.0, type=float)
parser.add_argument("--s2z", default=0.0, type=float)
parser.add_argument(
    "--dist", default=1.0e3, type=float, help="distance to source in MegaParsecs"
)
parser.add_argument(
    "--incl",
    default=0.0,
...
parser.add_argument("--delta-t", default=1.0 / 4096.0, type=float)
parser.add_argument("--delta-f", default=1.0 / 128.0, type=float)
