...
for levdir in levdirs:
  ...
  cmd.getoutput('cp /home/p/pfeiffer/prayush/scratch/projects/CCE_modeldir/highResCce700.par highResCce.par')
  ...
  fout.write('/scinet/gpc/mpi/openmpi/1.4.4-intel-v12.1/bin/mpirun -np 8 ${RUNDIR}/cactus_pittnull ${RUNDIR}/${PARFILE}\n')
  fout.close()
  #
