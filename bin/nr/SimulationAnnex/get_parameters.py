...
parser.add_option("-t", "--output-catalog", metavar='file', help='output file name')
parser.add_option("--nr-input-dir", metavar='DIR', help='Main dir with nr sim',default='/mnt/raid-project/nr/tonyc/next100Runs/confg_AlignedSpinning/')
