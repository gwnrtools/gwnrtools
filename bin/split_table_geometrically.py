...
#~ parser.add_argument("--iteration-id", dest="iid",
                    ...
                    #~ type=int)
parser.add_argument("-t", "--tmplt-bank", metavar='file',
                    help='template bank to split')

parser.add_argument('-n', '--num', metavar='SAMPLES',
                    help='number of output banks',
                    type=int)
parser.add_argument('--mchirp-min', metavar='MC_MIN',
                    help="""Global minimum for mchirp. This should be consistent
with the bank provided.""",
                    type=float)
parser.add_argument('--mchirp-max', metavar='MC_MAX',
...
parser.add_argument("--comment",
                    help="Comment string to be stored in proc_id" )
parser.add_argument("-e", "--named",
