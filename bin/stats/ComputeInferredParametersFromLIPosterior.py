...
parser.add_option(
    "-o", "--output-posterior", metavar="FILE", help="Output file to be written"
)
parser.add_option(
    "-V",
    "--verbose",
...
def AddRedshiftAndSourceFrameParamsToPosterior(in_file, out_file):
    ...
    Headers, Data = LU.get_header_data_from_posterior_samples_file(
    ...
    for param in ["m1", "m2", "mc", "mtotal", "mf"]:
        ...
        Data, Headers = AppendQuantityToPosterior(
            Data, Headers, ms_array, "%s_source" % param
        )
    # Write File
