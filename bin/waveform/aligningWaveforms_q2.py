...
def align_waveforms_optimally(h_plus1, h_cross1, hplus2, hcross2, psd=None,\
  ...
  h_cross2 = TimeSeries(hcross2, epoch=hcross2._epoch, delta_t=hcross2.delta_t,\
                                  dtype=hcross2.dtype)
  #
  if psd == None: raise IOError("Need psd to be input for now!")
...
def make_inspiral_merger_plot( hp1, hc1, hp2, hc2, tscale=1., lp=0.9, rp=1.1,\
  ...
  ax1.plot(np.arange(len(hp1))*tscale, hp1, np.arange(len(hp2))*tscale, hp2,\
          lw=0.5)
  xmin, xmax = min(max_id1, max_id2)*lp*tscale, min(max_id1, max_id2)*rp*tscale
...
nrwav = UseNRinDA.nr_waveform(filename='/home/prayush/research/cita-papers/SEOBtesting/Paper1/plots/InvestigateSimulations/d11.5-q8.5-sA_0_0_0_sB_0_0_0/rhOverM_CcePITT_Asymptotic_GeometricUnits.h5', time_length=8)
...
nrwav2 = UseNRinDA.nr_waveform(filename='/home/prayush/research/cita-papers/SEOBtesting/Paper1/plots/InvestigateSimulations/d11.5-q8.5-sA_0_0_0_sB_0_0_0/rhOverM_Asymptotic_GeometricUnits.h5', time_length=8)
