...
def resample_and_extrapolate_psd(
    ...
    interpolated_psd = FrequencySeries(numpy.zeros(n), delta_f=delta_f, dtype=precision)
    ...
    interpolated_psd.data[data_f_mask] = psd_interp(interpolated_freq_vals[data_f_mask])
