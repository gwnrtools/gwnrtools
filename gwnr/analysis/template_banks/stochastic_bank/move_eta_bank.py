...
if (
    options.strict_region_alignedspin is False
    and options.mtotal_cut is None
    ...
    and options.insert_q is None
    and options.insert_eta is None
):
...
if options.remove_q is not None:
    options.remove_eta = options.remove_q / (1.0 + options.remove_q) ** 2
if options.insert_q is not None:
    options.insert_eta = options.insert_q / (1.0 + options.insert_q) ** 2
