...
if NUM_NEW_POINTS == 0:
    ...
    try:
        old_bank_table = table.get_table(
            old_bank_doc, lsctables.SimInspiralTable.tableName
        )
    except ValueError:
        old_bank_table = table.get_table(
            old_bank_doc, lsctables.SnglInspiralTable.tableName
        )
