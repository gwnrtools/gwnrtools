...
class plot_effectualness_vs_totalmass():
    ...
    def read_data_from_combined_file(self, simtags=[],
        ...
        if self.verbose:
            print >>sys.stderr, "reading from >> ", filename
    ...
    def read_data_from_all_files(self, tags=['./matches/*.h5'], simtags=[]):
        ...
        if self.verbose:
            print >>sys.stderr, "reading from >> ", infiles
        for f in infiles:
    ...
    def plot_effectualness_totalmass_vs_parameters(self, inkey=None,
        ...
        for idx, app in enumerate(self.ApproxList):
            ...
            # Mass - spin1
            if self.verbose:
                print >>sys.stderr, "Making M-S1 plot for ", app
            ...
            # Mass - spin2
            if self.verbose:
                print >>sys.stderr, "Making M-S2 plot for ", app
            ...
            # MassRatio - spin1
            if self.verbose:
                print >>sys.stderr, "Making Q-S1 plot for ", app
            ...
            # MassRatio - spin2
            if self.verbose:
                print >>sys.stderr, "Making Q-S2 plot for ", app
