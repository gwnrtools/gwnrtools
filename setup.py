...
if __name__ == "__main__":
    ...
    setup(name='GWNRTools',
          ...
          scripts=['bin/Utils/makepdf','bin/gwnrtools_create_bank_workflow','bin/banksim_generic.py','bin/choose_testpoints.py','bin/choose_best_testpoints.py','bin/remove_eliminated_testpoints.py','bin/split_table_geometrically.py', 'bin/gwnrtools_banksim', , 'bin/gwnrtools_create_banksim_workflow', 'bin/gwnrtools_faithsim', 'bin/gwnrtools_create_faithsim_workflow', 'bin/gwnrtools_force_success_from_condor_sub', 'bin/gwnrtools_sample_parameter_space', 'bin/Utils/toggle_lsctable_type', 'bin/Utils/ConvertHTMLToIpynb', 'bin/DataAnalysis/ComputeOptimalSNRForGWSignals.py', 'bin/NR/JoinDatainHDF', 'bin/Stats/ComputeInferredParametersFromLIPosterior.py'],
    )
